...
run: main.o stokenizer.o st_table.o token.o record.o parser.o table.o sql.o rpn.o shunting_yard.o
...
stokenizer.o: src/stokenizer.cpp includes/stokenizer.h st_table.o token.o
